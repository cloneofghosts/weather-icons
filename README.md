...
This set includes companion CSS files for popular weather service API. Presently there are mappings for Dark Sky, OpenWeatherMap, World Meteorological Organization, Weather.com, Yahoo, and WeatherBit. Check the [API List](https://erikflowers.github.io/weather-icons/api-list.html) to see the class names.
